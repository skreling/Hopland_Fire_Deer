...
```{r}
prefiredoe <- read.csv(here::here('Publication_Data','Collars','deer-gps-prefiredoe.csv'))
postfiredoe <- read.csv(here::here('Publication_Data','Collars','deer-gps-postfiredoe.csv'))
...
```{r}
prefirebuck <- read.csv(here::here('Publication_Data','Collars','deer-gps-prefirebuck.csv'))
postfirebuck <- read.csv(here::here('Publication_Data','Collars','deer-gps-postfirebuck.csv'))
